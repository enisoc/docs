...
When a database on the [free Hobby plan](/docs/concepts/billing#planet-scale-plans) is inactive for 7 days, the database will enter sleep mode. When a database is sleeping, all data is backed up, but you **will not be able to connect to any branches on the database** until it has been woken up.
